...
# SMARTDOCS_API_BASE_PATH = "https://staging-api.qiiro.eu"

# ALLOWED_HOSTS = [
#     "webapp-staging-zvfq4.ondigitalocean.app",
#     "staging-app.qiiro.eu",
# ]

# if (
#     len(sys.argv) > 0 and sys.argv[1] != "collectstatic"
# ):  # do not set DB for static collection  job
...
# AWS_ACCESS_KEY_ID = "TQ3UB7I56GCODTE243FT"
